...
plot(electric_data$Time,electric_data$Global_active_power,
     xlab="Time",ylab="Global Active Power",type="l")

plot(electric_data$Time,electric_data$Voltage,
...
plot(electric_data$Time,electric_data$Global_reactive_power,
